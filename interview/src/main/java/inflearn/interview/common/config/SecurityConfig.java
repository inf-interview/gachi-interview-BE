...
import inflearn.interview.common.filter.ExceptionHandlerFilter;
import inflearn.interview.common.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://gachi-interview.vercel.app", "http://localhost:3000")); // Allow all origins
